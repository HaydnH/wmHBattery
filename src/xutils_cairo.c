/*
 *   xutils_cairo.c - A collection of X-windows utilties for creating WindowMAker
 *		DockApps. 
 *
...
cairo_surface_t *cairo_create_x11_surface0(int x, int y)
{
   ...
   sfc = cairo_xlib_surface_create(display, wmgen.pixmap, DefaultVisual(display, screen), x, y);
